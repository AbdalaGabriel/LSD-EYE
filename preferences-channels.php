...
<head>
	...
	<link rel="stylesheet" type="text/css" href="style/assets/simple-switch.css">
					...
					<div class="panel grid channels">
						<div class="grid-item channel">
							...
							<div class="content o-hidden">
								<div class="info-box">
									<span class="quantity">2145</span>
									<span class="data">Usuarios Ahora</span>
								</div>

								<div class="info-box">
									<span class="quantity">21445</span>
									<span class="data">Usuarios en el día</span>
								</div>
							</div>
